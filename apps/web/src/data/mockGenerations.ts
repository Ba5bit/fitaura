  ...
  red_flag: {
    ...
    face: {
      card: {
        ...
        scores: [
          score('Aura', 71),
          score('Jaw Presence', 84),
          score('Face Harmony', 63, true),
  ...
  green_flag: {
    ...
    face: {
      card: {
        ...
        scores: [
          score('Aura', 92),
          score('Jaw Presence', 88),
          score('Face Harmony', 90),
  ...
  normie: {
    ...
    face: {
      card: {
        ...
        scores: [
          score('Aura', 58),
          score('Jaw Presence', 64),
          score('Face Harmony', 70),
          score('Main Character', 49, true),
        ],
