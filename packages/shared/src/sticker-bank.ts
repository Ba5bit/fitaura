...
export const STICKER_BANK: {
  ...
  face: [
    ...
    { id: 'larper', label: 'LARPER', tone: 'warn', rotation: -7 },
    { id: 'emo', label: 'EMO BOY', tone: 'chrome', rotation: -8, femmeLabel: 'EMO GIRL' },
    { id: 'pick-me', label: 'PICK ME', tone: 'warn', rotation: -6, femmeLabel: 'PICK ME GIRL' },
